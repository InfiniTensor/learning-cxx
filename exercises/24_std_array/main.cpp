...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(sizeof(arr) == 20, "Fill in the correct value.");// 假设int为4字节
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        ASSERT(sizeof(arr) == 64, "Fill in the correct value.");// 假设double为8字节
    }
    {
        std::array<char, 21> arr{"Hello, InfiniTensor!"};
        ASSERT(arr.size() == 21, "Fill in the correct value.");
        ASSERT(sizeof(arr) == 21, "Fill in the correct value.");// char为1字节
